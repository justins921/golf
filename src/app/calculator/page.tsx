    ...
    <div className="max-w-lg mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-xs text-gray-500 mb-1">Actual Yardage</label>
            <input
              type="number"
              value={yardage}
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">Elevation Change (ft)</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">Wind (mph)</label>
            <input
              type="number"
              value={wind}
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">Course Elevation (ft)</label>
            <input
              type="number"
              value={elevation}

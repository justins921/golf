  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center text-gray-400 text-[15px] mb-1">Create your account</p>
        ...
        <div className="bg-gray-900 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="text-[13px] font-semibold text-gray-400 uppercase tracking-wider mb-2 block">Confirm Password</label>
              <input
                type="password"

...
function DrillByTime() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl font-bold text-white mb-2">Drill By Time</h1>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {availableDrills.map((drill) => (
              ...
              >
                <h4 className="text-sm font-medium text-white">{drill.name}</h4>
      ...
      {selectedDrill && minutes && (
        <button
          onClick={handleStart}
          disabled={starting}
          className="px-5 py-2 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-500 disabled:opacity-50"
        >
